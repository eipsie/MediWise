...
public class DiagnosisController {
    ...
    @DoctorOnly
    public ResponseEntity<DiagnosisVO> createDiagnosis(@RequestBody @Valid CreateDiagnosisDTO createDTO) {
    ...
    @DoctorOnly
    public ResponseEntity<DiagnosisVO> getDiagnosis(
    ...
    @DoctorOnly
    public ResponseEntity<DiagnosisVO> updateDiagnosis(
            @Parameter(description = "诊断记录ID") @PathVariable Long id,
    ...
    @DoctorOnly
    public ResponseEntity<DiagnosisVO> analyzeDiagnosis(@RequestBody @Valid DiagnosisAnalyzeDTO analyzeDTO) {
    ...
    @DoctorOnly
    public ResponseEntity<Page<DiagnosisVO>> getPatientDiagnoses(
    ...
    public ResponseEntity<Page<DiagnosisVO>> listDiagnoses(
            @Parameter(description = "页码") @RequestParam(defaultValue = "1") int page,
            @Parameter(description = "每页大小") @RequestParam(defaultValue = "10") int size,
